...
<!--Authors: Tyler Chi, Liam Connor, David Isaksen, Nicholas Sukhu, Huy Vu
	...
	This is the HTML page for the login page linked to the create account page for the IS448 Group project for team Groot.-->
...
<html xmlns = "http://www.w3.org/1999/xhtml">
	...
	<!-- php section to connect to database and insert new account as well as pull existing emails and passwords into arrays for login checking -->
	<?php
		...
		/* get information from create account using POST and store in variables */
		...
		$query = "INSERT INTO CUSTOMERS(cust_email, cust_fName, cust_lName, cust_number, cust_password) VALUES('$email', '$fName','$lName','$phone', '$pass')";
	...
	<body>
		...
		<div class="top">
			...
			<a class="topButtons" href="https://swe.umbc.edu/~nsukhu1/is448/groupProject2/login.php">Log In</a> 
			<a class="topButtons" href="https://swe.umbc.edu/~nsukhu1/is448/groupProject2/account.html">Create Account</a>
