...
<!--Authors: Tyler Chi, Liam Connor, David Isaksen, Nicholas Sukhu, Huy Vu
	...
	This is the HTML page for the manage user page linked to both login pages for the IS448 Group project for team Groot.-->
...
<html xmlns = "http://www.w3.org/1999/xhtml">
	...
	<?php
		...
		/* get information from login using POST and store in variables */
		$email = $_POST["email"];
		
		/* create query to update who the current logged in user is */
		$query = "UPDATE Se set custEmail = '".$email."' where sessionID = 1";
			...
			<div id="privacy">
				...
				<form action="">
					<p>
						...
						<input type="checkbox" name="security2" value="setting6"/>&nbsp;&nbsp;Allow others to see where you have stayed.<br /><br />
						<input type="checkbox" name="security3" value="setting7"/>&nbsp;&nbsp;Allow reccomendations based on past stays.<br /><br />
